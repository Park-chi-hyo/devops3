...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.authorizeHttpRequests(auth -> auth
				...
				.permitAll().requestMatchers("/", "/member/join.do", "/member/login.do", "/member/insertMember.do", "/board/openBoardList.do", "/api/member/join", "/api/member/status", "/api/board/list")
